...
def to_parser(interactions: list[tuple[str, str, str, Span]], gene_list: list[str]) -> list[tuple[str, str, str, Span]]:
    ...
    for i in range(len(interactions)):
        ...
        for i, interaction in enumerate(parsed_interactions): 
            if interaction[0] != None and interaction[1] in ["activate", "inhibit"] and interaction[2] != None:
